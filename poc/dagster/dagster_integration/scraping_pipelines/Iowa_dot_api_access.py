...
def fetch_raw_ia():
    ...
    base_url = os.getenv("BASE_URL_IA_TEST")
    IntegrationName = os.getenv("INTEGRATION_NAME_IA_TEST")
    secrectAccessKey = os.getenv("SECRET_ACCESS_KEY_IA_TEST") 
...
def transform_ia_data(entity_dataframes):
    """Transform the raw data fetched from Iowa DOT API."""
    ...
    df_join1 = df_join[['contract_id','Description_contracts','Location_contracts', 'contractor_longname',
    ...
    return df_join1, associated_projectNumbers
